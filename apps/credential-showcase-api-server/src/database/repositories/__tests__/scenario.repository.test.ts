...
describe('Database scenario repository tests', (): void => {
  ...
  it('Should save issuance scenario to database', async (): Promise<void> => {
    ...
    const stepAsset = savedIssuanceScenario.steps[0].asset as Asset
    expect(stepAsset).not.toBeNull()
    expect(stepAsset!.mediaType).toEqual(asset.mediaType)
    expect(stepAsset!.fileName).toEqual(asset.fileName)
    expect(stepAsset!.description).toEqual(asset.description)
    expect(stepAsset!.content).toStrictEqual(asset.content)
    ...
    const hsAsset = savedIssuanceScenario.personas[0].headshotImage as Asset
    expect(hsAsset).not.toBeNull()
    ...
    const biAsset = savedIssuanceScenario.personas[0].bodyImage as Asset
    expect(biAsset).not.toBeNull()
    ...
    const bnAsset = savedIssuanceScenario.bannerImage as Asset
    expect(bnAsset!.id).toBeDefined()
    expect(bnAsset!.mediaType).toEqual(asset.mediaType)
    expect(bnAsset!.fileName).toEqual(asset.fileName)
    expect(bnAsset!.description).toEqual(asset.description)
    expect(bnAsset!.content).toStrictEqual(asset.content)
  })
  ...
  it('Should save presentation scenario to database', async (): Promise<void> => {
    ...
    const stepAsset = savedPresentationScenario.steps[0].asset as Asset
    expect(stepAsset).not.toBeNull()
    expect(stepAsset!.mediaType).toEqual(asset.mediaType)
    expect(stepAsset!.fileName).toEqual(asset.fileName)
    expect(stepAsset!.description).toEqual(asset.description)
    ...
    const hsAsset = savedPresentationScenario.personas[0].headshotImage as Asset
    expect(hsAsset).not.toBeNull()
    expect(hsAsset!.id).toBeDefined()
    expect(hsAsset!.mediaType).toEqual(asset.mediaType)
    expect(hsAsset!.fileName).toEqual(asset.fileName)
    expect(hsAsset!.description).toEqual(asset.description)
    expect(hsAsset!.content).toStrictEqual(asset.content)
    const iAsset = savedPresentationScenario.personas[0].bodyImage as Asset
    expect(iAsset).not.toBeNull()
    expect(iAsset!.id).toBeDefined()
    expect(iAsset!.mediaType).toEqual(asset.mediaType)
    expect(iAsset!.fileName).toEqual(asset.fileName)
    expect(iAsset!.description).toEqual(asset.description)
    expect(iAsset!.content).toStrictEqual(asset.content)
    const bnAsset = savedPresentationScenario.bannerImage as Asset
    expect(bnAsset!.id).toBeDefined()
    expect(bnAsset!.mediaType).toEqual(asset.mediaType)
    expect(bnAsset!.fileName).toEqual(asset.fileName)
    expect(bnAsset!.description).toEqual(asset.description)
  ...
  it('Should get scenario by id from database', async (): Promise<void> => {
    ...
    const hsAsset = fromDb.personas[0].headshotImage as Asset
    expect(hsAsset).not.toBeNull()
    expect(hsAsset!.id).toBeDefined()
    expect(hsAsset!.mediaType).toEqual(asset.mediaType)
    expect(hsAsset!.fileName).toEqual(asset.fileName)
    expect(hsAsset!.description).toEqual(asset.description)
    expect(hsAsset!.content).toStrictEqual(asset.content)
    const biAsset = fromDb.personas[0].bodyImage as Asset
    expect(biAsset).not.toBeNull()
    expect(biAsset!.id).toBeDefined()
    expect(biAsset!.mediaType).toEqual(asset.mediaType)
    expect(biAsset!.fileName).toEqual(asset.fileName)
  ...
  it('Should update scenario in database', async (): Promise<void> => {
    ...
    const stepAsset = updatedIssuanceScenarioResult.steps[0].asset as Asset
    expect(stepAsset).not.toBeNull()
    expect(stepAsset!.mediaType).toEqual(asset.mediaType)
    expect(stepAsset!.fileName).toEqual(asset.fileName)
    expect(stepAsset!.description).toEqual(asset.description)
    ...
    const hsAsset = updatedIssuanceScenarioResult.personas[0].headshotImage as Asset
    expect(hsAsset).not.toBeNull()
    expect(hsAsset!.id).toBeDefined()
    expect(hsAsset!.mediaType).toEqual(asset.mediaType)
    expect(hsAsset!.fileName).toEqual(asset.fileName)
    expect(hsAsset!.description).toEqual(asset.description)
    expect(hsAsset!.content).toStrictEqual(asset.content)
    const biAsset = updatedIssuanceScenarioResult.personas[0].bodyImage as Asset
    expect(biAsset).not.toBeNull()
    expect(biAsset!.id).toBeDefined()
    expect(biAsset!.mediaType).toEqual(asset.mediaType)
    expect(biAsset!.fileName).toEqual(asset.fileName)
  ...
  it('Should add scenario step to database', async (): Promise<void> => {
    ...
    const stepAsset = fromDb.steps[1].asset as Asset
    expect(stepAsset).not.toBeNull()
    expect(stepAsset!.mediaType).toEqual(asset.mediaType)
    expect(stepAsset!.fileName).toEqual(asset.fileName)
    expect(stepAsset!.description).toEqual(asset.description)
  ...
  it('Should get scenario step by step id from database', async (): Promise<void> => {
    ...
    const dbAsset = fromDb.asset as Asset
    expect(dbAsset).not.toBeNull()
    expect(dbAsset!.mediaType).toEqual(asset.mediaType)
    expect(dbAsset!.fileName).toEqual(asset.fileName)
    expect(dbAsset!.description).toEqual(asset.description)
    expect(dbAsset!.content).toStrictEqual(asset.content)
  ...
  it('Should get all scenario steps from database', async (): Promise<void> => {
    ...
    const dbAsset = fromDb[0].asset as Asset
    expect(dbAsset).not.toBeNull()
    expect(dbAsset!.mediaType).toEqual(asset.mediaType)
    expect(dbAsset!.fileName).toEqual(asset.fileName)
    expect(dbAsset!.description).toEqual(asset.description)
  ...
  it('Should update scenario step in database', async (): Promise<void> => {
    ...
    const updatedStep: NewStep = {
      ...
      asset: (savedIssuanceScenario.steps[0].asset as Asset)!.id,
    }
    ...
    const updAsset = updatedStepResult.asset as Asset
    expect(updAsset).not.toBeNull()
    expect(updAsset!.mediaType).toEqual(asset.mediaType)
    expect(updAsset!.fileName).toEqual(asset.fileName)
    expect(updAsset!.description).toEqual(asset.description)
    expect(updAsset!.content).toStrictEqual(asset.content)
